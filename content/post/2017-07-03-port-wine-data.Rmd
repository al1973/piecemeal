...
**Lower Corgo** -- Is centered around Peso da Régua, downstream from the river Corgo. It is the wettest and on average coolest zone. It mainly produces the grapes for the cheaper Ruby and Twny ports.  
...
**Tawny with indication of age**: Tawny Ports with age indication (10, 20, 30, 40 years). The number of years does not indicate the age of the grapes, but the average age of the blends. Every bottle of a designated age should have the same flavor regardless of the year it was bottled.  
